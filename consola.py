# ==============================================================================
# EJECUCIÓN EN CONSOLA / TERMINAL - BÚSQUEDAS NO INFORMADAS
# ==============================================================================
...
def menu_visualizar_arbol(resultados):
    """Submenú interactivo para inspeccionar los árboles de búsqueda en consola."""
    nombres_opcion = {
        "1": "BFS",
        "2": "DFS",
        "3": "DFS iterativa",
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("\n¡Programa de consola finalizado con exito!")
            break
        else:
